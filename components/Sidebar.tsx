...
const Sidebar = () => {
  ...
  const userProfile = false; // TODO: change to useState for auth-check

  const normalLink =
    'flex items-center justify-center xl:justify-start gap-3 hover:bg-primary p-3 cursor-pointer font-semibold text-[#F51997] rounded';
